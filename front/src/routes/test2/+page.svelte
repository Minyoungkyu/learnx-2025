<script lang="ts">
    ...
    import { SvelteFlow, MarkerType, Background, type Edge, type Node, ConnectionMode } from '@xyflow/svelte';
   
    import '@xyflow/svelte/dist/style.css';

    import ResizeAbleNode from './ResizeAbleNode.svelte';
  ...
  <button type="button" class="btn btn-sm btn-primary w-24" onclick={addNode}>
    Add Node
  </button>
